...
shinyUI(shinyUI(navbarPage(theme = shinythemes::shinytheme("sandstone"),
                           ...
                           tabPanel(h5("Country"), 
                                    ...
                                    sidebarPanel(
                                      ...
                                      tags$h3(class = "subheader", "About the Map"),
                                      tags$p(class = "guide", "The graph above shows the ratio of number of films that PASSED the test to the number of  
                                             ...
                                             but this rate is based on only one film that was produced in the country.", align = "left"),
                                      tags$p(class = "guide", "Some countries have
                                             ...
                                             5 movies that have been evaluated by the Bechdel test.", align = "left"),
                                      tags$h3(class = "subheader", "Observations"),
                                      tags$p(class = "guide", "We still found value in showing the data
                                             ...
                                             affect the likehood of having two women talk to each other." , align = "left")
                                    )
                           ),
